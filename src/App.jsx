...
function App() {
  ...
  return (
    ...
    <main className='flex relative w-screen  bg-[#202020] flex-col min-h-screen pb-[70px]'>
      <header className='w-full h-[109px] bg-[#D30000] flex justify-center items-center gap-[12px]'>
      ...
      <iframe width="318" height="511" src="https://www.youtube.com/embed/vgvhkaHFFOo?si=LnrNfMv1Kb4eRo1k"
        title="YouTube video player"
        frameBorder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
        referrerPolicy="strict-origin-when-cross-origin"
        allowFullScreen
        className=" rounded-[10px] border-solid border-[2px] border-[#FFFFFF]/65"
        ></iframe>
